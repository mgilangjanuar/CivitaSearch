...
public class LecturerEditorActivity extends BaseActivity {
...
//                Do nothing
    ...
    public int findLayout() {
        return R.layout.activity_lecturer_editor;
    }
    ...
    void saveCLick() {
        ...
        Intent returningBack = new Intent(this, LecturerDetailActivity.class).putExtra("uid", getIntent().getStringExtra("uid"));
